<html lang="fr">
    <head>
		...
		<meta name="description" content="Trouve facilement tes prochaines soirées rock, swing, salsa, bachata, kizomba, tango ou salon près de chez toi.">
    ...
    <body>
			...
			<div id="left_panel">
				<div id="espace_form" class="noselect collapse in">
					<form id="form_rechercher_lieu" class="myform" action="<?php echo $bouton_retour;?>" method="post">
						<input type="hidden" name="nb_jour_calendrier" id="nb_jour_calendrier" value="<?php echo $nb_jour_calendrier;?>"/>
						<div id="box1">
				...
				<div id="espace_resultat">
					<div id="billetCounter">
						...
						<div id="zone_filtre">
							<div id="legende">
								<div>
									<img src="../ressources/images/website/icon-human-shoes-footprints.png" style="width:10px;height:10px;">
									 = initiation, stage
								</div>
								<div>
							...
							<div id="box9" title="Période d'affichage">
								<div class="input-group input-group-filtre">
									<div class="input-group-addon input-group-addon-filtre"><i class="fa fa-calendar-plus-o"></i></div>
									<select name="nb_jour_calendrier_input" id="nb_jour_calendrier_input" class="form-control form-control-filtre">
										<option value="7" id="nb_jour_7" <?php if($nb_jour_calendrier==7){echo "selected";};?>>7 jours</option>
										<option value="30" id="nb_jour_30" <?php if($nb_jour_calendrier==30){echo "selected";};?>>30 jours</option>
									</select>
								</div>
							</div>
						</div>
		...
		<script src="../ressources/controleur/js/presenterBillet_event.js"></script>
