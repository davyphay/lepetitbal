<html lang="fr">
    <head>
		...
		<meta name="description" content="Trouve facilement ton cours ou ta soirée rock, swing, salsa, bachata, kizomba, tango ou salon près de chez toi.">
    ...
    <body>
		...
		<header>
            <div id="header_left">
				...
				<div id="zone_bouton">
					<div class="dropdown">
						<button class="btn btn-primary dropdown-toggle btn-menu btn-menu-recherche" type="button" data-toggle="dropdown">Je cherche : Tous<i class="fa fa-caret-down caret-menu-deroulant" aria-hidden="true"></i></button>
						<ul class="dropdown-menu dropdown-menu-recherche">
						  ...
						  <li class="active"><a href="https://www.lepetitbal.com/cours-et-soirees-dansantes"><i class="fa fa-list" style="margin-right:9px"></i>Tous les lieux dansants</a></li>
						</ul>
					</div> 
				</div>
			</div>
